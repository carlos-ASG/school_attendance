...
from .models import NonSchoolDay
from .models import SchoolCycle
...
class StudentAdmin(ImportExportModelAdmin, ModelAdmin):
    ...
    fieldsets = (
        (
            None,
            {"fields": ("first_name", "paternal_surname", "maternal_surname", "email")},
        ),
...
class StudentGroupAdmin(ModelAdmin):
    ...
    def student_count(self, obj: StudentGroup) -> int:
