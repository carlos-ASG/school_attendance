...
from school.calendar import get_active_cycle, get_non_school_day
...
class DashboardView(TeacherRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        today = timezone.now().date()
        active_cycle = get_active_cycle(today)
        non_school_day = get_non_school_day(active_cycle, today) if active_cycle else None
