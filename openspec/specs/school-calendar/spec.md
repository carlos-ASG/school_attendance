# School Calendar Specification

## Purpose

Define the school calendar domain: School Cycles (name, type, date range, duration bounds, mutual exclusivity), Non-School Days belonging to a cycle, and their Django admin management — the calendar that bounds when attendance sessions may be created.
